...
# python3 scripts/joint_scripts/train_3dvlp.py --use_checkpoint /home/ljc/work/3DVLP/outputs/exp_joint/2025-12-27_22-05-44  --gpu 0 --use_multiview --use_normal --batch_size 8 --epoch 220 --lang_num_max 8 --coslr --lr 0.002 --no_caption --lang_num_aug 0 --unfreeze 6  --debug --use_con --use_diou_loss
