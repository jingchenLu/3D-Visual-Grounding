...
# CUDA_VISIBLE_DEVICES=1 python3 scripts/joint_scripts/train_3dvlp.py --gpu 0 --use_multiview --use_normal --batch_size 1 --epoch 200 --lang_num_max 8 --coslr --lr 0.002 --no_caption --lang_num_aug 0 --unfreeze 6  --debug --use_con --use_diou_loss

# 无多视图版
CUDA_VISIBLE_DEVICES=0 python3 scripts/joint_scripts/train_3dvlp.py --gpu 0  --use_color --use_normal --batch_size 8 --epoch 200 --lang_num_max 8 --coslr --lr 0.002 --no_caption --lang_num_aug 0 --unfreeze 6  --debug --use_con --use_diou_loss
